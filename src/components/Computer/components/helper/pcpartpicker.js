...
var getCases = function (cb) {
  ...
  request(
    'https://pcpartpicker.com/products/case/fetch/?xcx=0&mode=list&xslug=&search=',
    function (error, response, html1) {
      ...
      if (html1.toString().lastIndexOf('page=') != -1) {
        numPages = parseInt(
          html1
            .toString()
            .substring(html1.toString().lastIndexOf('page=') + 5)
            .split('\\"')[0]
        );
      }
      ...
      var fetch = function (q) {
        if (q < numPages) {
          request(
            'https://pcpartpicker.com/products/case/fetch/?xcx=0&page=' +
              (q + 1) +
              '&mode=list&xslug=&search=',
            function (error, response) {
              //console.log(JSON.parse(JSON.stringify(response.body)));
              var actualHTML = JSON.parse(JSON.stringify(response.body))
...
var getPSUs = function (cb) {
  ...
  request(
    'https://pcpartpicker.com/products/power-supply/fetch/?xcx=0&mode=list&xslug=&search=',
    function (error, response, html1) {
      var numPages = 1;
      ...
      var fetch = function (q) {
        if (q < numPages) {
          request(
            'https://pcpartpicker.com/products/power-supply/fetch/?xcx=0&page=' +
              (q + 1) +
              '&mode=list&xslug=&search=',
            function (error, response) {
...
var getGPUs = function (cb) {
  ...
  request(
    'https://pcpartpicker.com/products/video-card/fetch/?xcx=0&mode=list&xslug=&search=',
    function (error, response, html1) {
      var numPages = 1;
      ...
      var fetch = function (q) {
        if (q < numPages) {
          request(
            'https://pcpartpicker.com/products/video-card/fetch/?xcx=0&page=' +
              (q + 1) +
              '&mode=list&xslug=&search=',
            function (error, response) {
              var actualHTML = JSON.parse(response.body).result.html;
...
var getStorage = function (cb) {
  ...
  request(
    'https://pcpartpicker.com/products/internal-hard-drive/fetch/?xcx=0&mode=list&xslug=&search=',
    function (error, response, html1) {
      var numPages = 1;
      ...
      var fetch = function (q) {
        if (q < numPages) {
          request(
            'https://pcpartpicker.com/products/internal-hard-drive/fetch/?xcx=0&page=' +
              (q + 1) +
              '&mode=list&xslug=&search=',
            function (error, response) {
              var actualHTML = JSON.parse(response.body).result.html;
...
var getMemory = function (sortOptions, cb) {
  ...
  if (sortOptions.size) {
    ...
    for (let s = 0; s < sortOptions.size.length; s++) {
      sortString +=
        (parseInt(sortOptions.size[s].split('GB')[0]) * 1024).toString() +
        '00' +
        sortOptions.size[s].split('(')[1].split('x')[0];
  ...
  if (sortOptions.speed) {
    ...
    for (let s = 0; s < sortOptions.speed.length; s++) {
      sortString +=
        sortOptions.speed[s].split('DDR')[1].split('-')[0] +
        '0' +
        sortOptions.speed[s].split('-')[1];
  ...
  request(
    'https://pcpartpicker.com/products/memory/fetch/?xcx=0' +
      sortString +
      '&mode=list&xslug=&search=',
    function (error, response, html1) {
      var numPages = 1;
...
var getMotherboards = function (sortOptions, cb) {
  ...
  request(
    'https://pcpartpicker.com/products/motherboard/fetch/?xcx=0' +
      sortString +
      '&mode=list&xslug=&search=',
    function (error, response, html1) {
      var numPages = 1;
...
var getCoolers = function (cb) {
  ...
  request(
    'https://pcpartpicker.com/products/cpu-cooler/fetch/?mode=list&xslug=&search=',
    function (error, response, html1) {
      var numPages = 1;
      ...
      var fetch = function (q) {
        if (q < numPages) {
          request(
            'https://pcpartpicker.com/products/cpu-cooler/fetch/?page=' +
              (q + 1) +
              '&mode=list&xslug=&search=',
            function (error, response) {
              var actualHTML = JSON.parse(response.body).result.html;
...
var getCPUs = function (sortOptions, cb) {
  ...
  request(
    'https://pcpartpicker.com/products/cpu/fetch/?xcx=0' +
      sortString +
      '&mode=list&xslug=&search=',
    function (error, response, html1) {
      var numPages = 1;
